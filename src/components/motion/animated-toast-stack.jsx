          ...
          <div className="flex items-start gap-3">
              ...
              <AnimatePresence mode="popLayout" initial={false}>
                <motion.span
                  ...
                  initial={
                    reduce
                      ? { opacity: 0 }
                      : { opacity: 0, y: 8, scale: 0.25, filter: "blur(4px)" }
                  }
                  animate={
                    reduce
                      ? { opacity: 1 }
            ...
            <div className={cn("min-w-0 flex-1", classNames?.content)}>
              ...
              {toast.action ? (
                <button
                  ...
                  className={cn(
                    "mt-2 inline-flex min-h-10 items-center rounded-full bg-primary/[0.06] px-3 text-xs font-medium text-foreground transition-colors hover:bg-primary/[0.1] active:scale-[0.96]",
                    classNames?.action
                  )}>
                  {toast.action.label}
                </button>
            ...
            {canDismiss ? (
              <button
                ...
                className={cn(
                  "-m-1.5 inline-flex size-10 shrink-0 items-center justify-center rounded-full text-muted-foreground transition-colors hover:bg-primary/[0.06] hover:text-foreground active:scale-[0.96]",
                  classNames?.close
                )}>
