...
export function SideRays({
  ...
  useEffect(() => {
    ...
    const render = (time = 0) => {
      ...
      if (motionSpeed) animationFrame = requestAnimationFrame(render);
    };
  ...
  }, [blend, falloff, intensity, isVisible, motionSpeed, opacity, origin, rayColor1, rayColor2, saturation, spread, tilt]);

  return <div ref={containerRef} className={`sideRaysContainer ${className}`.trim()} />;
}
