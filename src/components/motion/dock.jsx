...
export function Dock({ children, size = 44, className }) {
  const pillLayoutId = useId();
  const context = useMemo(() => ({ size, pillLayoutId }), [size, pillLayoutId]);
...
export function DockItem({ children, className, onClick, active, ...rest }) {
